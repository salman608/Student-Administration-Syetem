                        ...
                        @foreach($applys as $apply)
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{route('accept-teacher',$apply->id)}}" class="btn btn-warning btn-sm">Accept</a>
                                   <a href="{{route('reject-by-teacher',$apply->id)}}" class="btn btn-danger btn-sm">Reject</a>
                                 </td>
                            </tr>
                        @endforeach
                        </tbody>
