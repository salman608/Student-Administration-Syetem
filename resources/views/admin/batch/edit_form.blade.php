    ...
    <section class="container-fluid mb-5">
        <div class="row content login-form">
            <div class="col-12 pl-0 pr-0">
                ...
                <form method="POST" action="{{route('batch-update',$batch->id)}}"autocomplete="off" class="form-inline">
                    @csrf

                    <div class="form-group col-12 mb-3">
                        <label for="batch" class="col-sm-3 col-form-label text-right">Add Batch</label>
                        <input type="text" name="batch_name" value="{{$batch->batch_name}}" class="form-control col-sm-9
