        ...
        <div class="row content ">
            <div class="col-md-12 pl-0 pr-0">
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Student Registration</h4>
                    </div>
                </div>
                <form method="POST" action="" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        <label for="classId" class="col-sm-4 col-form-label text-right">Batch Name</label>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        <label for="sectionId" class="col-sm-4 col-form-label text-right">Section</label>
                        <select name="section_id" class="form-control col-sm-8" id="sectionId" required>
