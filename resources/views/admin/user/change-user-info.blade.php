        ...
        <div class="row content login-form">
            <div class="col-12 pl-0 pr-0">
                ...
                <form method="POST" action="{{ route('user-info-update',$user->id) }}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                    ...
                    @enderror" name="name" value="{{ $user->name }}" placeholder="Name" required autofocus>
                    ...
                    @enderror" name="mobile" value="{{ $user->mobile }}" placeholder="8801xxxxxxxxx" required autofocus>
                    ...
                    @enderror" name="email" value="{{ $user->email }}" placeholder="Email Address" required autofocus>
