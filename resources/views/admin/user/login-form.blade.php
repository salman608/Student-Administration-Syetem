...
<head>
    ...
    <title>Administration Manner | Login Form</title>
            ...
            <div class="col-12 pl-0 pr-0">
                ...
                <form action="{{ route('login') }}" method="post" enctype="multipart/form-data" autocomplete="off"
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input type="text" name="email" placeholder="Email Address" class="form-control col-sm-9
                         @error('password') is-invalid @enderror" id="fatherMobile" minlength="8" required>
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <div class="input-group col-sm-9 pl-0 pr-0">
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                placeholder="Password" id="password" name="password" required autofocus>
